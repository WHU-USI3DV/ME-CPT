...
empty_cache = False
enable_amp = True
save_path="/home/luqizhang/work/test"

#test_mode
mask=False
test_voxel_size=0.3
test_root="/home/luqizhang/work/data/Urb3dcd/Test"
save_file="/home/luqizhang/work/test"
test_type="SemSegTester"
weight =  "/home/luqizhang/work/data/checkpoints/Urb3dcd/model/model_best.pth" # path to model weight
...
# model settings
model = dict(
    type="DefaultSegmentorV3",  #V3 Multitask V5 singletask
    num_classes=7,
    num_classes_seg=4,
...
data_root = "/home/luqizhang/work/data/Urb3dcd"
