...
class Point(Dict):
    ...
    def serialization(self, order="z", depth=None, shuffle_orders=False,grid_size=0.05):
        """
        ...
        if depth is None:
            # Adaptive measure the depth of serilization cube (length = 2 ^ depth)
